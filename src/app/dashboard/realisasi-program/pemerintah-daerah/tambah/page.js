        ...
        <DashboardLayout Content={<Breadcrumb />}>
            <div className="flex flex-col items-center mt-6 py-12 gap-6 border-2 border-slate-700 rounded-md bg-white drop-shadow-md">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-8 w-full">
                    <div className="flex justify-evenly mx-auto w-1/2 gap-4">
                    ...
                    <div className="flex flex-col items-center gap-2">
                        <label className="font-semibold">Pilih Sub-kegiatan</label>
                        <select 
                            className="w-1/2 bg-transparent text-slate-600 text-sm border border-slate-200 rounded pl-3 py-1.5 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:drop-shadow-md appearance-none cursor-pointer"
                            {...register("subkegiatan")}>
                            <option value="">pilih sub-kegiatan...</option>
                            <option value="1">sub-kegiatan nomor 1</option>
                            <option value="2">sub-kegiatan nomor 2</option>
                        </select>
                    </div>
