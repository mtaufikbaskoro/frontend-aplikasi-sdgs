...
export default function Navbar (props) {
    ...
    return (
        <nav className={`sticky top-0 flex justify-between items-center bg-white z-50 ${isOpen ? "pl-48" : "pl-16"} transition-all ease-in ease-out py-6 border-b-4 border-green-900 bg-white`}>
